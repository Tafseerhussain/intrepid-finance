...
<div class="flex min-w-full items-center justify-center min-h-screen bg-if-shark">

    <div class="min-h-screen w-full md:w-1/2 md:max-w-lg md:min-h-0 p-8 text-left bg-white md:shadow-lg">
